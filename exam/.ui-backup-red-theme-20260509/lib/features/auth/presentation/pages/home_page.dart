  ...
  Future<void> _loadAll() async {
    try {
      ...
      final Map<String, dynamic> user =
          (me["user"] is Map<String, dynamic>) ? me["user"] : <String, dynamic>{};
      ...
      for (final m in daily) {
        ...
        sumUpd += upd; sumScored += sc; if (upd > 0) days++;
      }
      _mUpdates = sumUpd; _mScored = sumScored; _mActiveDays = days;
            ...
            if (items.isEmpty)
              ...
              ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  final int? totalCandidates = _toNullableInt(e["totalCandidates"]);
                  ...
                  final int remain  = pending ?? ((totalCandidates != null) ? (total - graded) : 0);
                  final double prog = (totalCandidates != null && total > 0) ? (graded / total) : 0.0;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(999),
        border: Border.all(color: const Color(0xFF3730A3).withOpacity(0.15)),
      ),
      child: Text(
        "ตรวจแล้ว $checked",
        style: const TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _MiniStat(title: 'อัปเดตรวม', value: '$totalUpdates')),
              const SizedBox(width: 10),
              const SizedBox(width: 10),
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(value,
                style: const TextStyle(
                    color: Colors.redAccent, fontWeight: FontWeight.w900, fontSize: 18)),
          ],
        ),
      );
}
