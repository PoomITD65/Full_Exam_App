...
class _CalendarPageState extends State<CalendarPage> {
  ...
  Future<void> _loadBreakdownForDay(DateTime day) async {
    ...
    try {
      final items =
          await ApiService.dailyBreakdown(day: DateUtils.dateOnly(day));
                  ...
                  children: [
                    ...
                    if (_summaryError != null)
                      ...
                      Expanded(
                        child: Text(
                          'อัปเดตวันนี้: ' +
                              ((_dailyUpdates[DateUtils.dateOnly(_selected)] ??
                                      0))
                                  .toString() +
                              ' ครั้ง',
                      ...
                      if (_loadingSummary)
                        const SizedBox(
                          ...
                          child: CircularProgressIndicator(
                              strokeWidth: 2, color: kSubtle),
                        ),
                      IconButton(
                        tooltip: 'รีเฟรชสรุปเดือนนี้',
                        icon: const Icon(Icons.refresh_rounded, color: kSubtle),
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      'รายงานรายวัน',
                      style:
                          TextStyle(color: kText, fontWeight: FontWeight.w800),
                    ),
                    ...
                    if (_breakdownError != null)
                      ...
                      ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          final pending = (m['pending'] as num?)?.toInt() ??
                              (updates - scored);
